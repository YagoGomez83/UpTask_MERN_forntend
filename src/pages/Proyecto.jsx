    ...
    <>
      ...
      {admin && (
        <button
          ...
          type="button"
          className="text-sm px-5 py-3 w-full md:w-auto rounded-lg uppercase font-bold bg-sky-400 text-white text-center mt-5 flex gap-2 hover:bg-sky-800 transition-colors justify-center"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
      ...
      <div className="bg-white shadow mt-10 rounded-lg">
        {proyecto.tareas?.length ? (
          ...
          <p className="text-center my-5 p-10 font-bold uppercase">
